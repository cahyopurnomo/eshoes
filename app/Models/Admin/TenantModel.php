...
class TenantModel extends Model
{
    ...
    protected $allowedFields    = ['tenant_idx', 'tenant_name', 'email', 'passwd', 'phone', 'city_idx', 'logo', 'province_idx', 'facebook', 'instagram', 'linkedin', 'twitter', 'youtube', 'tiktok', 'tokopedia', 'lazada', 'shopee', 'blibli', 'status', 'created_at', 'updated_at', 'deleted_at'];
